...
export function MusicPlayer({
  ...
  useEffect(() => {
    ...
    audio.src = track.src;
    audio.volume = 0.1; // lower volume further
    audio.load();
    setCurrentTime(0);
    ...
    >
      ...
      {artwork ? (
        ...
        <img
          ...
          className="absolute -top-20 left-0 z-20 h-20 w-20 rounded-xl object-cover shadow-lg shadow-black/30 ring-1 ring-white/20"
        />
      ) : null}
